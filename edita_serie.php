        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="container">
                ...
                <p class="note note-danger d-none" id="paragrafo_alerta"><strong>Alerta:</strong> Ocorreu um erro ao tentar editar a serie, por favor tente novamente e certifique de estar preenchendo os campos corretamente. </p>
                    ...
                    <form class="text-center border border-light p-5" method="post" action="edita_serie.php?id=<?= $id_serie ?>">
...
var result = <?= !empty($nome) && !empty($produtora) && !empty($ano) && !empty($descricao) && !empty($qtd_temp) && !empty($categoria) && !empty($status) ? edita_serie() : 1 ?>
